  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      {thresholdAlerts.length > 0 && (
        <div className="animate-fade-in mb-6 p-4 rounded-xl bg-yellow-50 dark:bg-yellow-500/8 border border-yellow-200 dark:border-yellow-500/15">
          <h3 className="text-sm font-semibold text-yellow-700 dark:text-yellow-300 mb-2">⚠️ Settlement Alerts</h3>
          <div className="space-y-1">
            {thresholdAlerts.map((alert) => (
              <p key={alert.userId} className="text-sm text-yellow-700 dark:text-yellow-200/80">
